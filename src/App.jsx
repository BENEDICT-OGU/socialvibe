    ...
    <div className="flex justify-around items-center px-2 py-3">
      {[
        { 
          ...
          icon: <FiHome size={16} />,
          name: "Home",
          activeIcon: <FiHome size={16} className="fill-current" />
        },
        { 
          to: "/explore", 
          icon: <FiCompass size={16} />,
          name: "Explore",
          activeIcon: <FiCompass size={16} className="fill-current" />
        },
        { 
          to: "/createPost", 
          icon: (
            <div className="flex items-center justify-center -mt-8 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full p-3 shadow-lg shadow-pink-500/30">
        ...
        { 
          ...
          icon: <FiFilm size={16} />,
          name: "reels",
          activeIcon: <FiFilm size={16} className="fill-current" />,
        ...
        >
          <div className={`flex flex-col items-center ${location.pathname === item.to ? "text-pink-500" : "text-gray-500 dark:text-gray-400"}`}>
            {location.pathname === item.to && item.activeIcon ? item.activeIcon : item.icon}
            {!item.isSpecial && (
              <span className={`text-xs mt-1 ${location.pathname === item.to ? "text-pink-500 font-medium" : "text-gray-500 dark:text-gray-400"}`}>
                {item.name}
              </span>
            )}
          </div>
